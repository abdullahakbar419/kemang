var config = {
    geojson: "http://kemang.test/geojson/UMKM_DESA_TEGAL_FeaturesToJS.json",
    title: "Kemang",
    layerName: "UMKM",
    ...
    table = [
        {
            ...
            events: {
                "click .zoom": function (e, value, row, index) {
                    map.fitBounds(
                        featureLayer.getLayer(row.leaflet_stamp).getBounds()
                    );
            ...
            layer.on({
                ...
                mouseover: function (e) {
                    if (config.hoverProperty) {
                        $(".info-control").html(
                            feature.properties[config.hoverProperty]
                        );
                        $(".info-control").show();
                    }
                },
